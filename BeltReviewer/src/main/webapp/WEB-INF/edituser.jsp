	...
	<div id="wrapper">
		...
		<fieldset id="register">
			...
			<c:forEach items="${user}" var="u">
				<form:form action="/edituser" method="put" modelAttribute="editUser">
					<p>
						<form:label for="fname" path="fname">First Name</form:label>
						<form:input type="text" path="fname" value="${u.fname}"/><form:errors path="fname"/>
					</p>
					<p>
						<form:label for="lname" path="lname">Last Name</form:label>
						<form:input type="text" path="lname" value="${u.lname}"/><form:errors path="lname"/>
					</p>
					<p>
						<form:label for="city" path="city">City</form:label>
						<form:input type="text" path="city" id="city" value="${u.city}"/><form:errors path="city"/>
					</p>
					<p>
						<form:label for="state" path="state">State</form:label>
						<form:select name="state" path="state">
								
								<form:option value="${u.state}">${u.state}</form:option>
					...
					<p>
						...
						<form:input path="username" value="${u.username}"/><form:errors path="username"/>
					</p>
					<p>
						<form:label for="email" path="email">Email</form:label>
						<form:input type="email" path="email" value="${u.email}"/><form:errors path="email"/>
					</p>
					<p>
						<form:label for="password" path="password">Password</form:label>
						<form:input type="password" path="password" value="${u.password}"/><form:errors path="password"/>
					</p>
